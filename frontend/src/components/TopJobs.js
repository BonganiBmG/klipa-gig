                    ...
                    <div className="text-center">
                        ...
                        <div className="list-tabs mt-40">
                            <ul className="nav nav-tabs" role="tablist">
                                ...
                                <li><a id="nav-tab-job-5" href="#tab-job-5" data-bs-toggle="tab" role="tab" aria-controls="tab-job-5" aria-selected="false"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/page/homepage1/retail.svg" alt="jobBox" /> Retail &amp; Products</a></li>
