    ...
    <div>
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="font-lg color-text-paragraph-2 wow animate__ animate__fadeInUp animated" style={{visibility: `visible`, animationName: `fadeInUp`}}>Jobs is a curated job board of the best jobs for developers, designers and marketers in the tech industry.</p>
          </div>
          <div className="mt-50">
            <div className="row">
