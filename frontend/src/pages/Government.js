        ...
        <div className="container">
          <div className="banner-hero banner-company">
            <div className="block-banner text-center">
              ...
              <h3 className="wow animate__ animate__fadeInUp animated" style={{visibility: `visible`, animationName: `fadeInUp`}}>Browse Government Opportunities</h3>
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                      <div className="display-flex2">
                        ...
                        <div className="box-view-type"><a className="view-type"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/template/icons/icon-list.svg" alt="jobBox"/></a><a className="view-type"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/template/icons/icon-grid-hover.svg" alt="jobBox"/></a></div>
                      </div>
                    </div>
                  </div>
                </div>
