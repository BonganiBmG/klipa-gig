                    ...
                    <div className="container">
                        <div className="row mt-10">
                            <div className="col-lg-8 col-md-12">
                                <h3>{job.title}</h3>
                                <div className="mt-0 mb-15"><ReactTimeAgo date={job.createdAt} locale="en-US"/></div>
                            </div>
                                ...
                                <div className="job-overview">
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 d-flex">
                                            ...
                                            <div className="sidebar-text-info ml-10"><span className="text-description industry-icon mb-10">Industry</span><strong className="small-heading"> Mechanical / Auto</strong></div>
                                        </div>
                                    ...
                                    <div className="row mt-25">
                                        <div className="col-md-6 d-flex mt-sm-15">
                                            ...
                                            <div className="sidebar-text-info ml-10"><span className="text-description jobtype-icon mb-10">Updated</span><strong className="small-heading"><ReactTimeAgo date={job.updatedAt} locale="en-US"/></strong></div>
                                        </div>
                                        <div className="col-md-6 d-flex mt-sm-15">
