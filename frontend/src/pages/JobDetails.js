            ...
            <main className="main">
                <section className="section-box-2">
                    <div className="container">
                        <div className="banner-hero banner-image-single"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/page/job-single/thumb.png" alt="jobBox" /></div>
                                ...
                                <div className="job-overview">
                                    ...
                                    <div className="row mt-25">
                                        <div className="col-md-6 d-flex mt-sm-15">
                                            ...
                                            <div className="sidebar-text-info ml-10"><span className="text-description salary-icon mb-10">Salary</span><strong className="small-heading">R800 - R1000</strong></div>
                                        </div>
                                        <div className="col-md-6 d-flex">
                                            <div className="sidebar-icon-item"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/page/job-single/experience.svg" alt="jobBox" /></div>
                                    ...
                                    <div className="row mt-25">
                                        <div className="col-md-6 d-flex mt-sm-15">
                                            <div className="sidebar-icon-item"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/page/job-single/job-type.svg" alt="jobBox" /></div>
                ...
                <section className="section-box mt-50 mb-50">
                    <div className="container">
                        <div className="text-left">
                            <h2 className="section-title mb-10 wow animate__animated animate__fadeInUp" style={{ visibility: `visible`, animationName: `fadeInUp` }}>Featured Jobs</h2>
                            <p className="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp" style={{ visibility: `visible`, animationName: `fadeInUp` }}>Get the latest news, updates and tips</p>
                        </div>
                        <div className="mt-50">
                            <div className="box-swiper style-nav-top">
                                <div className="swiper-container swiper-group-4 swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                    <div className="swiper-wrapper pb-10 pt-5" id="swiper-wrapper-ba5abfe4b812dabc" aria-live="off" style={{ transform: `translate3d(-2034px, 0px, 0px)`, transitionDuration: `0ms` }}><div className="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" style={{ width: `309px`, marginRight: `30px` }} role="group" aria-label="1 / 4">
                                    ...
                                    </div><div className="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1" style={{ width: `309px`, marginRight: `30px` }} role="group" aria-label="2 / 4">
                                            <div className="card-grid-2 hover-up">
                                                <div className="card-grid-2-image-left"><span className="flash"></span>
                                        ...
                                        </div><div className="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="3" style={{ width: `309px`, marginRight: `30px` }} role="group" aria-label="4 / 4">
                                            <div className="card-grid-2 hover-up">
                                                <div className="card-grid-2-image-left"><span className="flash"></span>
                                                    <div className="image-box"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/brands/brand-4.png" alt="jobBox" /></div>
                                                    <div className="right-info"><a className="name-job" href="company-details.html">Dailymotion</a><span className="location-small">Johannesburg, SA</span></div>
